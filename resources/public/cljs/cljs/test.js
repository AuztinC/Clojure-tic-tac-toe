...
var G__12412 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12412,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12412;
}
}));
...
var len__5749__auto___12417 = arguments.length;
var i__5750__auto___12418 = (0);
while(true){
if((i__5750__auto___12418 < len__5749__auto___12417)){
args__5755__auto__.push((arguments[i__5750__auto___12418]));

var G__12419 = (i__5750__auto___12418 + (1));
i__5750__auto___12418 = G__12419;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12414){
var G__12415 = cljs.core.first.call(null,seq12414);
var seq12414__$1 = cljs.core.next.call(null,seq12414);
var G__12416 = cljs.core.first.call(null,seq12414__$1);
var seq12414__$2 = cljs.core.next.call(null,seq12414__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12415,G__12416,seq12414__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__12420_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12420_SHARP_));
...
var temp__5825__auto___12422 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___12422)){
var message_12423 = temp__5825__auto___12422;
cljs.core.println.call(null,message_12423);
} else {
}
...
var temp__5825__auto___12424 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___12424)){
var message_12425 = temp__5825__auto___12424;
cljs.core.println.call(null,message_12425);
} else {
}
...
var output_dir__$1 = (function (){var G__12426 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__12426,"/"].join('');
} else {
return G__12426;
}
})();
...
var G__12427 = exception.stack;
var G__12427__$1 = (((G__12427 == null))?null:clojure.string.split_lines.call(null,G__12427));
var G__12427__$2 = (((G__12427__$1 == null))?null:cljs.core.get.call(null,G__12427__$1,depth));
if((G__12427__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12427__$2);
}
} else {
...
var vec__12428 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12428,(0),null);
var column = cljs.core.nth.call(null,vec__12428,(1),null);
var vec__12431 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12431,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12431,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12431,(2),null);
...
var m__$1 = (function (){var G__12434 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__12439 = (function (){var G__12437 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12437);
} else {
return G__12437;
}
})();
...
return cljs.core.vary_meta.call(null,G__12438,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__12443 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12443,(0),null);
var types = vec__12443;
...
return cljs.core.map.call(null,(function (p__12446){
var vec__12447 = p__12446;
var ns = cljs.core.nth.call(null,vec__12447,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12447,(1),null);
return (function (){
...
var G__12450 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__12451 = cljs.core.seq.call(null,vars__$1);
var chunk__12452 = null;
var count__12453 = (0);
var i__12454 = (0);
while(true){
if((i__12454 < count__12453)){
var v = cljs.core._nth.call(null,chunk__12452,i__12454);
var temp__5825__auto___12456 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5825__auto___12456)){
var t_12457 = temp__5825__auto___12456;
each_fixture_fn.call(null,((function (seq__12451,chunk__12452,count__12453,i__12454,t_12457,temp__5825__auto___12456,v,each_fixture_fn,G__12450,G__12450__$1,env,once_fixtures,each_fixtures,vec__12447,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12457)));
});})(seq__12451,chunk__12452,count__12453,i__12454,t_12457,temp__5825__auto___12456,v,each_fixture_fn,G__12450,G__12450__$1,env,once_fixtures,each_fixtures,vec__12447,ns,vars__$1))
);
} else {
}


var G__12458 = seq__12451;
var G__12459 = chunk__12452;
var G__12460 = count__12453;
var G__12461 = (i__12454 + (1));
seq__12451 = G__12458;
chunk__12452 = G__12459;
count__12453 = G__12460;
i__12454 = G__12461;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq.call(null,seq__12451);
if(temp__5825__auto__){
var seq__12451__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12451__$1)){
var c__5548__auto__ = cljs.core.chunk_first.call(null,seq__12451__$1);
var G__12462 = cljs.core.chunk_rest.call(null,seq__12451__$1);
var G__12463 = c__5548__auto__;
var G__12464 = cljs.core.count.call(null,c__5548__auto__);
var G__12465 = (0);
seq__12451 = G__12462;
chunk__12452 = G__12463;
count__12453 = G__12464;
i__12454 = G__12465;
continue;
} else {
var v = cljs.core.first.call(null,seq__12451__$1);
var temp__5825__auto___12466__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5825__auto___12466__$1)){
var t_12467 = temp__5825__auto___12466__$1;
each_fixture_fn.call(null,((function (seq__12451,chunk__12452,count__12453,i__12454,t_12467,temp__5825__auto___12466__$1,v,seq__12451__$1,temp__5825__auto__,each_fixture_fn,G__12450,G__12450__$1,env,once_fixtures,each_fixtures,vec__12447,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12467)));
});})(seq__12451,chunk__12452,count__12453,i__12454,t_12467,temp__5825__auto___12466__$1,v,seq__12451__$1,temp__5825__auto__,each_fixture_fn,G__12450,G__12450__$1,env,once_fixtures,each_fixtures,vec__12447,ns,vars__$1))
);
} else {
}


var G__12468 = cljs.core.next.call(null,seq__12451__$1);
var G__12469 = null;
var G__12470 = (0);
var G__12471 = (0);
seq__12451 = G__12468;
chunk__12452 = G__12469;
count__12453 = G__12470;
i__12454 = G__12471;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12450__$1)].join('')));
