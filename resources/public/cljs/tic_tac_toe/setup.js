...
var ai_count = cljs.core.count.call(null,cljs.core.filterv.call(null,(function (p1__8713_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ai","ai",760454697),p1__8713_SHARP_);
...
tic_tac_toe.setup.auto_advance = (function tic_tac_toe$setup$auto_advance(next_state){
cljs.core.prn.call(null,"next state ",next_state);

var next_player = (function (){var G__8717 = new cljs.core.Keyword(null,"turn","turn",75759344).cljs$core$IFn$_invoke$arity$1(next_state);
switch (G__8717) {
case "p1":
return cljs.core.first.call(null,new cljs.core.Keyword(null,"players","players",-1361554569).cljs$core$IFn$_invoke$arity$1(next_state));

break;
case "p2":
return cljs.core.second.call(null,new cljs.core.Keyword(null,"players","players",-1361554569).cljs$core$IFn$_invoke$arity$1(next_state));

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8717)].join('')));

}
})();
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"game","game",-441523833),new cljs.core.Keyword(null,"screen","screen",1990059748).cljs$core$IFn$_invoke$arity$1(next_state))){
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ai","ai",760454697),next_player)){
return cljs.core.reset_BANG_.call(null,tic_tac_toe.setup.state,tic_tac_toe.game.next_state.call(null,next_state));
} else {
return cljs.core.deref.call(null,tic_tac_toe.setup.state);
}
} else {
return cljs.core.deref.call(null,tic_tac_toe.setup.state);
