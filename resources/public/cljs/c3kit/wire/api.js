...
var len__5749__auto___16595 = arguments.length;
var i__5750__auto___16596 = (0);
while(true){
if((i__5750__auto___16596 < len__5749__auto___16595)){
args__5755__auto__.push((arguments[i__5750__auto___16596]));

var G__16597 = (i__5750__auto___16596 + (1));
i__5750__auto___16596 = G__16597;
continue;
} else {
}
break;
...
/** @this {Function} */
(c3kit.wire.api.configure_BANG_.cljs$lang$applyTo = (function (seq16571){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16571));
}));

c3kit.wire.api.handle_payload = (function c3kit$wire$api$handle_payload(handler,payload){
try{return handler.call(null,payload);
}catch (e16592){var e = e16592;
...
var G__16630 = cljs.core.deref.call(null,c3kit.wire.api.config);
var G__16630__$1 = (((G__16630 == null))?null:new cljs.core.Keyword(null,"redirect-fn","redirect-fn",281458973).cljs$core$IFn$_invoke$arity$1(G__16630));
if((G__16630__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__16630__$1,uri);
}
});
...
c3kit.wire.api.handle_api_response = (function c3kit$wire$api$handle_api_response(raw_response,p__16652){
var map__16656 = p__16652;
var map__16656__$1 = cljs.core.__destructure_map.call(null,map__16656);
var handler = cljs.core.get.call(null,map__16656__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
var map__16675_16707 = c3kit.wire.apic.conform_response.call(null,raw_response);
var map__16675_16708__$1 = cljs.core.__destructure_map.call(null,map__16675_16707);
var status_16709 = cljs.core.get.call(null,map__16675_16708__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var flash_16710 = cljs.core.get.call(null,map__16675_16708__$1,new cljs.core.Keyword(null,"flash","flash",934660619));
var payload_16711 = cljs.core.get.call(null,map__16675_16708__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
var version_16712 = cljs.core.get.call(null,map__16675_16708__$1,new cljs.core.Keyword(null,"version","version",425292698));
var uri_16713 = cljs.core.get.call(null,map__16675_16708__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
if(cljs.core.seq.call(null,flash_16710)){
cljs.core.run_BANG_.call(null,c3kit.wire.flash.add_BANG_,flash_16710);
} else {
}

if(cljs.core.truth_((function (){var and__5023__auto__ = version_16712;
if(cljs.core.truth_(and__5023__auto__)){
return cljs.core.not_EQ_.call(null,version_16712,new cljs.core.Keyword(null,"version","version",425292698).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,c3kit.wire.api.config)));
} else {
return and__5023__auto__;
}
})())){
c3kit.wire.api.new_version_BANG_.call(null,version_16712);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ok","ok",967785236),status_16709)){
c3kit.wire.api.handle_payload.call(null,handler,payload_16711);
} else {
}

if(((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"redirect","redirect",-1975673286),status_16709)) && (cljs.core.not.call(null,new cljs.core.Keyword(null,"no-redirect","no-redirect",-1477036586).cljs$core$IFn$_invoke$arity$1(options))))){
c3kit.wire.api.redirect.call(null,uri_16713);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1706214930),status_16709)){
var G__16695_16722 = options;
var G__16695_16723__$1 = (((G__16695_16722 == null))?null:new cljs.core.Keyword(null,"on-fail","on-fail",-589260753).cljs$core$IFn$_invoke$arity$1(G__16695_16722));
if((G__16695_16723__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__16695_16723__$1,payload_16711);
}
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",-978969032),status_16709)){
var G__16697_16724 = options;
var G__16697_16725__$1 = (((G__16697_16724 == null))?null:new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__16697_16724));
if((G__16697_16725__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__16697_16725__$1,payload_16711);
}
} else {
}

var G__16700 = options;
var G__16700__$1 = (((G__16700 == null))?null:new cljs.core.Keyword(null,"after-all","after-all",-54883998).cljs$core$IFn$_invoke$arity$1(G__16700));
if((G__16700__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__16700__$1);
}
});
