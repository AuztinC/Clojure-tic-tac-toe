...
var len__5749__auto___16685 = arguments.length;
var i__5750__auto___16686 = (0);
while(true){
if((i__5750__auto___16686 < len__5749__auto___16685)){
args__5755__auto__.push((arguments[i__5750__auto___16686]));

var G__16688 = (i__5750__auto___16686 + (1));
i__5750__auto___16686 = G__16688;
continue;
} else {
}
break;
...
/** @this {Function} */
(c3kit.wire.api.configure_BANG_.cljs$lang$applyTo = (function (seq16651){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16651));
}));
...
var G__16697 = cljs.core.deref.call(null,c3kit.wire.api.config);
var G__16697__$1 = (((G__16697 == null))?null:new cljs.core.Keyword(null,"redirect-fn","redirect-fn",281458973).cljs$core$IFn$_invoke$arity$1(G__16697));
if((G__16697__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__16697__$1,uri);
}
});
...
c3kit.wire.api.handle_api_response = (function c3kit$wire$api$handle_api_response(raw_response,p__16726){
var map__16728 = p__16726;
var map__16728__$1 = cljs.core.__destructure_map.call(null,map__16728);
var handler = cljs.core.get.call(null,map__16728__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var options = cljs.core.get.call(null,map__16728__$1,new cljs.core.Keyword(null,"options","options",99638489));
...
var map__16735_16769 = c3kit.wire.apic.conform_response.call(null,raw_response);
var map__16735_16770__$1 = cljs.core.__destructure_map.call(null,map__16735_16769);
var status_16771 = cljs.core.get.call(null,map__16735_16770__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var flash_16772 = cljs.core.get.call(null,map__16735_16770__$1,new cljs.core.Keyword(null,"flash","flash",934660619));
var payload_16773 = cljs.core.get.call(null,map__16735_16770__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
var version_16774 = cljs.core.get.call(null,map__16735_16770__$1,new cljs.core.Keyword(null,"version","version",425292698));
var uri_16775 = cljs.core.get.call(null,map__16735_16770__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
if(cljs.core.seq.call(null,flash_16772)){
cljs.core.run_BANG_.call(null,c3kit.wire.flash.add_BANG_,flash_16772);
} else {
}

if(cljs.core.truth_((function (){var and__5023__auto__ = version_16774;
if(cljs.core.truth_(and__5023__auto__)){
return cljs.core.not_EQ_.call(null,version_16774,new cljs.core.Keyword(null,"version","version",425292698).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,c3kit.wire.api.config)));
} else {
return and__5023__auto__;
}
})())){
c3kit.wire.api.new_version_BANG_.call(null,version_16774);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ok","ok",967785236),status_16771)){
c3kit.wire.api.handle_payload.call(null,handler,payload_16773);
} else {
}

if(((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"redirect","redirect",-1975673286),status_16771)) && (cljs.core.not.call(null,new cljs.core.Keyword(null,"no-redirect","no-redirect",-1477036586).cljs$core$IFn$_invoke$arity$1(options))))){
c3kit.wire.api.redirect.call(null,uri_16775);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1706214930),status_16771)){
var G__16747_16787 = options;
var G__16747_16788__$1 = (((G__16747_16787 == null))?null:new cljs.core.Keyword(null,"on-fail","on-fail",-589260753).cljs$core$IFn$_invoke$arity$1(G__16747_16787));
if((G__16747_16788__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__16747_16788__$1,payload_16773);
}
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",-978969032),status_16771)){
var G__16751_16793 = options;
var G__16751_16794__$1 = (((G__16751_16793 == null))?null:new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__16751_16793));
if((G__16751_16794__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__16751_16794__$1,payload_16773);
}
} else {
}

var G__16755 = options;
var G__16755__$1 = (((G__16755 == null))?null:new cljs.core.Keyword(null,"after-all","after-all",-54883998).cljs$core$IFn$_invoke$arity$1(G__16755));
if((G__16755__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__16755__$1);
}
});
