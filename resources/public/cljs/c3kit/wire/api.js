...
var G__16554 = (i__5750__auto___16553 + (1));
i__5750__auto___16553 = G__16554;
continue;
} else {
}
break;
...
/** @this {Function} */
(c3kit.wire.api.configure_BANG_.cljs$lang$applyTo = (function (seq16526){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16526));
}));

c3kit.wire.api.handle_payload = (function c3kit$wire$api$handle_payload(handler,payload){
try{return handler.call(null,payload);
}catch (e16537){var e = e16537;
...
var G__16549 = cljs.core.deref.call(null,c3kit.wire.api.config);
var G__16549__$1 = (((G__16549 == null))?null:new cljs.core.Keyword(null,"redirect-fn","redirect-fn",281458973).cljs$core$IFn$_invoke$arity$1(G__16549));
if((G__16549__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__16549__$1,uri);
}
});
...
c3kit.wire.api.handle_api_response = (function c3kit$wire$api$handle_api_response(raw_response,p__16568){
var map__16569 = p__16568;
var map__16569__$1 = cljs.core.__destructure_map.call(null,map__16569);
var handler = cljs.core.get.call(null,map__16569__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
var map__16572_16581 = c3kit.wire.apic.conform_response.call(null,raw_response);
var map__16572_16582__$1 = cljs.core.__destructure_map.call(null,map__16572_16581);
var status_16583 = cljs.core.get.call(null,map__16572_16582__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var flash_16584 = cljs.core.get.call(null,map__16572_16582__$1,new cljs.core.Keyword(null,"flash","flash",934660619));
var payload_16585 = cljs.core.get.call(null,map__16572_16582__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
var version_16586 = cljs.core.get.call(null,map__16572_16582__$1,new cljs.core.Keyword(null,"version","version",425292698));
var uri_16587 = cljs.core.get.call(null,map__16572_16582__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
if(cljs.core.seq.call(null,flash_16584)){
cljs.core.run_BANG_.call(null,c3kit.wire.flash.add_BANG_,flash_16584);
} else {
}

if(cljs.core.truth_((function (){var and__5023__auto__ = version_16586;
if(cljs.core.truth_(and__5023__auto__)){
return cljs.core.not_EQ_.call(null,version_16586,new cljs.core.Keyword(null,"version","version",425292698).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,c3kit.wire.api.config)));
} else {
return and__5023__auto__;
}
})())){
c3kit.wire.api.new_version_BANG_.call(null,version_16586);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"ok","ok",967785236),status_16583)){
c3kit.wire.api.handle_payload.call(null,handler,payload_16585);
} else {
}

if(((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"redirect","redirect",-1975673286),status_16583)) && (cljs.core.not.call(null,new cljs.core.Keyword(null,"no-redirect","no-redirect",-1477036586).cljs$core$IFn$_invoke$arity$1(options))))){
c3kit.wire.api.redirect.call(null,uri_16587);
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1706214930),status_16583)){
var G__16577_16588 = options;
var G__16577_16589__$1 = (((G__16577_16588 == null))?null:new cljs.core.Keyword(null,"on-fail","on-fail",-589260753).cljs$core$IFn$_invoke$arity$1(G__16577_16588));
if((G__16577_16589__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__16577_16589__$1,payload_16585);
}
} else {
}

if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",-978969032),status_16583)){
var G__16578_16590 = options;
var G__16578_16591__$1 = (((G__16578_16590 == null))?null:new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__16578_16590));
if((G__16578_16591__$1 == null)){
} else {
c3kit.apron.corec.invoke.call(null,G__16578_16591__$1,payload_16585);
}
} else {
}

var G__16579 = options;
var G__16579__$1 = (((G__16579 == null))?null:new cljs.core.Keyword(null,"after-all","after-all",-54883998).cljs$core$IFn$_invoke$arity$1(G__16579));
if((G__16579__$1 == null)){
return null;
} else {
return c3kit.apron.corec.invoke.call(null,G__16579__$1);
}
});
