...
c3kit.wire.ajax.server_down_QMARK_ = (function c3kit$wire$ajax$server_down_QMARK_(p__16684){
var map__16685 = p__16684;
var map__16685__$1 = cljs.core.__destructure_map.call(null,map__16685);
var error_code = cljs.core.get.call(null,map__16685__$1,new cljs.core.Keyword(null,"error-code","error-code",180497232));
var status = cljs.core.get.call(null,map__16685__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
...
var G__16686 = new cljs.core.Keyword(null,"params-type","params-type",1941495334).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(ajax_call));
if(cljs.core._EQ_.call(null,null,G__16686)){
return new cljs.core.Keyword(null,"transit-params","transit-params",357261095);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"transit","transit",359458387),G__16686)){
return new cljs.core.Keyword(null,"transit-params","transit-params",357261095);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"query","query",-1288509510),G__16686)){
return new cljs.core.Keyword(null,"query-params","query-params",900640534);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"form","form",-1624062471),G__16686)){
return new cljs.core.Keyword(null,"form-params","form-params",1884296467);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"edn","edn",1317840885),G__16686)){
return new cljs.core.Keyword(null,"edn-params","edn-params",894273052);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"json","json",1279968570),G__16686)){
return new cljs.core.Keyword(null,"json-params","json-params",-1112693596);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"multipart","multipart",1158197946),G__16686)){
return new cljs.core.Keyword(null,"multipart-params","multipart-params",-1033508707);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16686)].join('')));
...
var map__16687 = prep.call(null,ajax_call);
var map__16687__$1 = cljs.core.__destructure_map.call(null,map__16687);
var ajax_call__$1 = map__16687__$1;
var options = cljs.core.get.call(null,map__16687__$1,new cljs.core.Keyword(null,"options","options",99638489));
var params = cljs.core.get.call(null,map__16687__$1,new cljs.core.Keyword(null,"params","params",710516235));
var G__16688 = cljs.core.select_keys.call(null,options,c3kit.wire.ajax.pass_through_keys);
if(cljs.core.truth_(params)){
return cljs.core.assoc.call(null,G__16688,c3kit.wire.ajax.params_key.call(null,ajax_call__$1),params);
} else {
return G__16688;
}
});
c3kit.wire.ajax._do_ajax_request = (function c3kit$wire$ajax$_do_ajax_request(p__16689){
var map__16690 = p__16689;
var map__16690__$1 = cljs.core.__destructure_map.call(null,map__16690);
var ajax_call = map__16690__$1;
var method = cljs.core.get.call(null,map__16690__$1,new cljs.core.Keyword(null,"method","method",55703592));
var method_fn = cljs.core.get.call(null,map__16690__$1,new cljs.core.Keyword(null,"method-fn","method-fn",1314848696));
var url = cljs.core.get.call(null,map__16690__$1,new cljs.core.Keyword(null,"url","url",276297046));
var params = cljs.core.get.call(null,map__16690__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
var f__10406__auto__ = (function (){var switch__10314__auto__ = (function (state_16707){
var state_val_16708 = (state_16707[(1)]);
if((state_val_16708 === (1))){
var inst_16693 = (state_16707[(7)]);
var inst_16691 = cljs.core.swap_BANG_.call(null,c3kit.wire.ajax.active_ajax_requests,cljs.core.inc);
var inst_16693__$1 = c3kit.wire.ajax.request_map.call(null,ajax_call);
var inst_16694 = method_fn.call(null,url,inst_16693__$1);
var state_16707__$1 = (function (){var statearr_16709 = state_16707;
(statearr_16709[(8)] = inst_16691);

(statearr_16709[(7)] = inst_16693__$1);

return statearr_16709;
})();
return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_16707__$1,(2),inst_16694);
} else {
if((state_val_16708 === (2))){
var inst_16693 = (state_16707[(7)]);
var inst_16696 = (state_16707[(2)]);
var inst_16697 = cljs.core.__destructure_map.call(null,inst_16696);
var inst_16698 = cljs.core.get.call(null,inst_16697,new cljs.core.Keyword(null,"error-code","error-code",180497232));
var inst_16699 = cljs.core.get.call(null,inst_16697,new cljs.core.Keyword(null,"status","status",-1997798413));
var inst_16700 = cljs.core.get.call(null,inst_16697,new cljs.core.Keyword(null,"body","body",-2049205669));
var inst_16701 = (function (){var request = inst_16693;
var map__16692 = inst_16697;
var response = inst_16697;
var error_code = inst_16698;
var status = inst_16699;
var body = inst_16700;
return (function (){
...
var inst_16702 = (new cljs.core.Delay(inst_16701,null));
var inst_16703 = taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"debug","debug",-1608172596),"c3kit.wire.ajax",null,null,null,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),inst_16702,null,(80),null);
var inst_16704 = c3kit.wire.ajax.triage_response.call(null,inst_16697,ajax_call);
var inst_16705 = cljs.core.swap_BANG_.call(null,c3kit.wire.ajax.active_ajax_requests,cljs.core.dec);
var state_16707__$1 = (function (){var statearr_16710 = state_16707;
(statearr_16710[(9)] = inst_16703);

(statearr_16710[(10)] = inst_16704);
...
return (function() {
var c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto__ = null;
var c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto____0 = (function (){
var statearr_16711 = [null,null,null,null,null,null,null,null,null,null,null];
(statearr_16711[(0)] = c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto__);

(statearr_16711[(1)] = (1));

return statearr_16711;
});
var c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto____1 = (function (state_16707){
while(true){
var ret_value__10316__auto__ = (function (){try{while(true){
var result__10317__auto__ = switch__10314__auto__.call(null,state_16707);
...
}catch (e16712){var ex__10318__auto__ = e16712;
var statearr_16713_16721 = state_16707;
(statearr_16713_16721[(2)] = ex__10318__auto__);


if(cljs.core.seq.call(null,(state_16707[(4)]))){
var statearr_16714_16722 = state_16707;
(statearr_16714_16722[(1)] = cljs.core.first.call(null,(state_16707[(4)])));
...
var G__16727 = state_16707;
state_16707 = G__16727;
continue;
} else {
...
c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto__ = function(state_16707){
switch(arguments.length){
case 0:
return c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto____0.call(this);
case 1:
return c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto____1.call(this,state_16707);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto__.cljs$core$IFn$_invoke$arity$0 = c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto____0;
c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto__.cljs$core$IFn$_invoke$arity$1 = c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto____1;
return c3kit$wire$ajax$_do_ajax_request_$_state_machine__10315__auto__;
})()
})();
var state__10407__auto__ = (function (){var statearr_16715 = f__10406__auto__.call(null);
(statearr_16715[(6)] = c__10405__auto__);
...
args__5755__auto__.push((arguments[i__5750__auto___16735]));
...
/** @this {Function} */
(c3kit.wire.ajax.get_BANG_.cljs$lang$applyTo = (function (seq16717){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16718,G__16719,G__16720,seq16717__$3);
}));

c3kit.wire.ajax.post_BANG_ = (function c3kit$wire$ajax$post_BANG_(var_args){
var args__5755__auto__ = [];
var len__5749__auto___16741 = arguments.length;
var i__5750__auto___16742 = (0);
while(true){
if((i__5750__auto___16742 < len__5749__auto___16741)){
args__5755__auto__.push((arguments[i__5750__auto___16742]));

var G__16743 = (i__5750__auto___16742 + (1));
i__5750__auto___16742 = G__16743;
continue;
} else {
}
break;
...
/** @this {Function} */
(c3kit.wire.ajax.post_BANG_.cljs$lang$applyTo = (function (seq16723){
...
var G__16726 = cljs.core.first.call(null,seq16723__$2);
var seq16723__$3 = cljs.core.next.call(null,seq16723__$2);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16724,G__16725,G__16726,seq16723__$3);
}));

c3kit.wire.ajax.request_BANG_ = (function c3kit$wire$ajax$request_BANG_(var_args){
var args__5755__auto__ = [];
var len__5749__auto___16744 = arguments.length;
var i__5750__auto___16745 = (0);
while(true){
if((i__5750__auto___16745 < len__5749__auto___16744)){
args__5755__auto__.push((arguments[i__5750__auto___16745]));

var G__16746 = (i__5750__auto___16745 + (1));
i__5750__auto___16745 = G__16746;
continue;
} else {
}
break;
...
var G__16747__delegate = function (url__$1,p__16737){
var vec__16738 = p__16737;
var req = cljs.core.nth.call(null,vec__16738,(0),null);
...
var G__16747 = function (url__$1,var_args){
var p__16737 = null;
...
while (G__16748__i < G__16748__a.length) {G__16748__a[G__16748__i] = arguments[G__16748__i + 1]; ++G__16748__i;}
  p__16737 = new cljs.core.IndexedSeq(G__16748__a,0,null);
} 
return G__16747__delegate.call(this,url__$1,p__16737);};
G__16747.cljs$lang$maxFixedArity = 1;
G__16747.cljs$lang$applyTo = (function (arglist__16749){
var url__$1 = cljs.core.first(arglist__16749);
var p__16737 = cljs.core.rest(arglist__16749);
return G__16747__delegate(url__$1,p__16737);
});
...
/** @this {Function} */
(c3kit.wire.ajax.request_BANG_.cljs$lang$applyTo = (function (seq16729){
...
var G__16732 = cljs.core.first.call(null,seq16729__$2);
var seq16729__$3 = cljs.core.next.call(null,seq16729__$2);
var G__16733 = cljs.core.first.call(null,seq16729__$3);
var seq16729__$4 = cljs.core.next.call(null,seq16729__$3);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16730,G__16731,G__16732,G__16733,seq16729__$4);
}));
